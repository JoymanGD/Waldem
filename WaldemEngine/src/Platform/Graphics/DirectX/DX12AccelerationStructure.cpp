...
namespace Waldem
{
    ...
    //BOTTOM LEVEL
    DX12AccelerationStructure::DX12AccelerationStructure(WString name, ID3D12Device5* device, DX12CommandList* cmdList, AccelerationStructureType type, WArray<RayTracingGeometry>& geometries) : AccelerationStructure(name, type)
    {
    ...
    //TOP LEVEL
    DX12AccelerationStructure::DX12AccelerationStructure(WString name, ID3D12Device5* device, DX12CommandList* cmdList, AccelerationStructureType type, WArray<RayTracingInstance>& instances) : AccelerationStructure(name, type)
    {
