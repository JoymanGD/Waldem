...
namespace Waldem
{
    DX12Buffer::DX12Buffer(ID3D12Device* device, DX12CommandList* cmdList, WString name, BufferType type, void* data, uint32_t size, uint32_t stride) : Buffer(name, type, size, stride)
    {
