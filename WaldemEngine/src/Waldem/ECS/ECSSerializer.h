...
namespace Waldem
{
    ...
    public:
        ...
        static void serialize(flecs::world& ecs, flecs::entity type, const void *ptr) 
        {
            ...
            Serializer{ecs}.serializeOps(ecs_vec_first_t(&ts.ops, flecs::meta::op_t), ecs_vec_count(&ts.ops), ptr);
        }
    ...
    private:
        ...
        void serializeStruct(flecs::meta::op_t *ops, const void *ptr) 
        {
        ...
        void serializeArray(flecs::meta::op_t *ops, int32_t elem_count, const void *ptr) 
        {
            printf("[");
        ...
        void serializeVector(flecs::meta::op_t *ops, const void *ptr) 
        {
        ...
        void serializeOps(flecs::meta::op_t *ops, int32_t op_count, const void *base) 
        {
