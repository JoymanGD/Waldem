...
namespace Waldem
{
    class WALDEM_API ShadowmapRenderingSystem : public DrawSystem
    {
    ...
    public:
        ...
        void Initialize(InputManager* inputManager, ResourceManager* resourceManager) override
        {
            ...
            resources.Add(GraphicResource("RootConstants", RTYPE_Constant, nullptr, sizeof(uint32_t), sizeof(uint32_t), 1));
            resources.Add(GraphicResource("WorldTransforms", RTYPE_Buffer, worldTransforms.GetData(), sizeof(Matrix4), worldTransforms.GetSize(), 0));
