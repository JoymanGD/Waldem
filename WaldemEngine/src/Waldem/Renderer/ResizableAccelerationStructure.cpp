...
namespace Waldem
{
    ...
    void ResizableAccelerationStructure::SetData(int id, WString& name, Buffer* VertexBuffer, Buffer* IndexBuffer, DrawCommand drawCommand, uint vertexCount, const Transform& transform)
    {
    ...
    void ResizableAccelerationStructure::UpdateGeometry(int id, Buffer* vertexBuffer, Buffer* indexBuffer, DrawCommand drawCommand, uint vertexCount)
    {
        WArray geometries { RayTracingGeometry(vertexBuffer, indexBuffer, drawCommand, vertexCount) };
