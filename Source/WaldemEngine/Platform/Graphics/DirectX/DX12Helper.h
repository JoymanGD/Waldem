...
namespace Waldem
{
    ...
    {
    public:
        static WString MBFromW(LPCWSTR pwsz, UINT cp = 0)
        {
        ...
        static LPCWSTR WFromMB(const WString& str, UINT cp = 0)
        {
        ...
        static std::wstring StringToLPCWSTR(const WString& str)
        {
        ...
        static D3D12_DESCRIPTOR_RANGE_TYPE ResourceTypeToRangeType(GraphicResourceType resourceType)
        {
            switch (resourceType)
            {
            case RTYPE_Constant:
