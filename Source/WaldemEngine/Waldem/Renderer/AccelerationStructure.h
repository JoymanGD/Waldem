...
namespace Waldem
{
    ...
    public:
        ...
        RayTracingGeometry(Buffer* vertexBuffer, Buffer* indexBuffer, DrawIndexedCommand drawCommand, uint vertexCount) : VertexBuffer(vertexBuffer), IndexBuffer(indexBuffer), DrawCommand(drawCommand), VertexCount(vertexCount) {}
        virtual ~RayTracingGeometry() {}
        
        Buffer* VertexBuffer = nullptr;
        Buffer* IndexBuffer = nullptr;
        DrawIndexedCommand DrawCommand = {0,1,0,0,0};
        uint VertexCount;
    };
