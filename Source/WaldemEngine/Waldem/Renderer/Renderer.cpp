...
namespace Waldem
{
    ...
    void Renderer::DrawIndirect(uint numCommands, Buffer* indirectBuffer, bool isIndexed)
    {
        Instance->PlatformRenderer->DrawIndirect(numCommands, indirectBuffer, isIndexed);
    }
