...
namespace Waldem
{
    ...
    public:
        ...
        {
            IndirectBuffer = ResizableBuffer("GizmoIndirectBuffer", BufferType::IndirectBuffer, sizeof(IndirectIndexedCommand), 128);
        ...
        void AddIcon(flecs::entity e, Transform& t, GizmoType type)
        {
            ...
            IndirectIndexedCommand& cmd = IndirectCommands[gizmoId];
            cmd.DrawId = packed;
            cmd.Command = { (uint)GizmoIndices.Num(), 1, 0, 0, 0 };
        ...
        void ChangeLightIcon(flecs::entity e, Light& light)
        {
            ...
            if (IdManager::GetId(e, GizmoDrawIdType, lightEntityId))
            {
                ...
                IndirectIndexedCommand& cmd = IndirectCommands[lightEntityId];
                cmd.DrawId = ((uint)lightEntityId << 16) | (uint)gizmoType;

                IndirectBuffer.UpdateData(&cmd, sizeof(IndirectIndexedCommand), lightEntityId * sizeof(IndirectIndexedCommand));
            }
        }
        ...
        void RemoveIcon(flecs::entity e)
        {
            ...
            if (IdManager::GetId(e, GizmoDrawIdType, gizmoId))
            {
                ...
                IndirectBuffer.UpdateData(&drawCommand, sizeof(IndirectIndexedCommand), gizmoId * sizeof(IndirectIndexedCommand));
