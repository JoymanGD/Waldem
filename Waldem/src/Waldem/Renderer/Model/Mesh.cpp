...
namespace Waldem
{
	CMesh::CMesh(void* vertexBufferData, uint32_t vertexBufferDataSize, uint32_t* indexBufferData, uint32_t indexBufferDataSize, WArray<Vector3> positions, WArray<uint> indices, Material* material, AABB bBox, String name, Matrix4 objectMatrix)
	{
