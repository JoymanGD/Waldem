...
namespace Waldem
{
    ...
    public:
        Quad()
        {
            VertexBuffer = Renderer::CreateBuffer(BufferType::VertexBuffer, QuadVertices, sizeof(QuadVertices));
            IndexBuffer = Renderer::CreateBuffer(BufferType::IndexBuffer, QuadIndices, sizeof(QuadIndices));
