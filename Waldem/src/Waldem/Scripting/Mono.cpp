...
namespace Waldem
{
    void Mono::Initialize()
    {
        ...
        //Init mono
        mono_set_assemblies_path((currentPath + "/mono/lib/4.5").c_str());
        ...
        auto testAssembly = LoadCSharpAssembly(currentPath + "ScriptEngine.dll");
    ...
    MonoAssembly* Mono::LoadCSharpAssembly(String assemblyPath)
    {
        uint32_t fileSize = 0;
    ...
    MonoClass* Mono::GetClass(MonoAssembly* assembly, const String& className, const String& namespaceName)
    {
        MonoImage* image = mono_assembly_get_image(assembly);
