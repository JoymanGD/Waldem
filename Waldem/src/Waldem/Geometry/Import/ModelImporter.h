...
namespace Waldem
{
    ...
    public:
        ...
        virtual Model* Import(std::string& path, bool relative = true) override = 0;

    protected:
        const aiScene* ImportInternal(std::string& path, ModelImportFlags importFlags = ModelImportFlags::None, bool relative = true);
