...
namespace Waldem
{
    ...
    class WALDEM_API CollisionRenderingSystem : ISystem
    {
    ...
    public:
        ...
        void Initialize(SceneData* sceneData, InputManager* inputManager, ResourceManager* resourceManager) override
        {
            ...
            WArray<Resource> meshColliderRenderingResources;
            meshColliderRenderingResources.Add(Resource("RootConstants", RTYPE_Constant, nullptr, sizeof(SMeshColliderRenderingConstants), sizeof(SMeshColliderRenderingConstants), 0));
