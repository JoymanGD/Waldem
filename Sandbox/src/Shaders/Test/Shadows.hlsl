...
float CalculateShadowFactor(Texture2D<float> Shadowmap, SamplerComparisonState cmpSampler, float4 worldPos, float3 normal, float4x4 view, float4x4 projection)
{
