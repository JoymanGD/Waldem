...
namespace Sandbox
{
	void DefaultScene::Initialize(Waldem::SceneData* sceneData)
	{
		...
		sponzaEntity.Add<Waldem::ModelComponent>(importer.Import("Content/Models/Sponza/Sponza.gltf", true));
		...
		dirLightEntity.Add<Waldem::Light>(Waldem::Vector3(1, 1, 1), 1.0f, Waldem::LightType::Directional, 100.0f);
